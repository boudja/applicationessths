...
public class emploidutemps2 extends AppCompatActivity {
    PDFView pdfres;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_emploidutemps2);
        pdfres=(PDFView)findViewById(R.id.pdfres);
        SharedPreferences sharedPreferences = getSharedPreferences("lienemp", Context.MODE_PRIVATE);
